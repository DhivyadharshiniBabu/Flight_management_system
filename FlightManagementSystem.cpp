...
class about
{
	public:
		void Aboutus()
		{
			cout<<"DD Airlines was one of the Famous Airlines developed since 2007. Since then,\nour airline is the world's leading airline with 2 biggest airplanes.\nWe provide our customers high service in cuisine, comfort and care.\nSo make a plan and fly to your Dream destination with DD Airlines."<<endl<<endl;
